"""
Croston's Method Statistical Model

For intermittent demand forecasting.
Separates demand size and demand interval, then forecasts each separately.
...
class CrostonModel(BaseForecastModel):
    ...
    def __init__(self):
        super().__init__(model_name="croston")
    ...
    def get_model_info(self) -> dict:
        ...
        return {
            ...
            "type": "statistical",
            "description": "For intermittent demand forecasting",
            "version": "1.0.0"
        }
    ...
    async def predict(
        ...
        # Croston's Formula: Forecast = z / p
        ...
        # For Croston, we use a simple approximation based on historical variability
