...
"""
from sqlalchemy import Column, String, Integer, DateTime, Boolean, Text, UniqueConstraint, Index
...
class Supplier(Base):
    ...
    # Default ordering conditions (used when creating product-supplier links)
    default_moq = Column(Integer, default=0, nullable=False)  # Default Minimum Order Quantity
    default_lead_time_days = Column(Integer, default=14, nullable=False)  # Default lead time in days
